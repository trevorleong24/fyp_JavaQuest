...
$sql = "
  SELECT g.student_id,
   ...
   WHERE g.quiz_id = 'QZ01'  -- Specific to easy game
...
$userStmt = $conn->prepare("
  SELECT MAX(score) AS my_best
    FROM gameprogress
   WHERE student_id = ?
     AND quiz_id = 'QZ01'  -- Specific to easy game
");
...
<body>
  <video class="video-background" autoplay muted loop playsinline>
    <source src="../video/background house.mp4" type="video/mp4">
  </video>
  ...
  <div class="panels-container">
    ...
    <div class="lessons-panel" style="max-height: 400px; overflow-y: auto;">
      ...
      <!-- Chapter 1 -->
      <details class="chapter" id="chapter1">
      ...
      <!-- Chapter 2 -->
      <details class="chapter" id="chapter2">
      ...
      <!-- Chapter 3 -->
      <details class="chapter" id="chapter3">
      ...
      <!-- Chapter 4 -->
      <details class="chapter" id="chapter4">
      ...
      <!-- Chapter 5 -->
      <details class="chapter" id="chapter5">
      ...
      <!-- Chapter 6 -->
      <details class="chapter" id="chapter6">
  ...
  <!-- Game Board -->
  <div class="cont">
    <img src="../image/easy1.png" alt="Game Background" class="board-bg" />
    ...
    <div class="box" id="b25"><div class="tokens"></div></div>
  ...
  <!-- Pass the easy‑mode quiz ID into your JS -->
  <script>
    // Get quiz_id from URL parameters, if not present use default value QZ01
    const urlParams = new URLSearchParams(window.location.search);
    const QUIZ_ID = urlParams.get('quiz_id') || 'QZ01';
  </script>
