...
$sql = "
  SELECT g.student_id,
   ...
   WHERE g.quiz_id = 'QZ03'  -- Specific to hard game
...
$userStmt = $conn->prepare("
  SELECT MAX(score) AS my_best
    FROM gameprogress
   WHERE student_id = ?
     AND quiz_id = 'QZ03'  -- Specific to hard game
");
...
<video class="video-background" autoplay muted loop playsinline>
    <source src="../video/background hard.mp4" type="video/mp4">
  </video>
  ...
  <!-- Game Board -->
  <div class="cont">
    <img src="../image/hard1.png" alt="Game Background" class="board-bg" />
...
tokens"></div></div>
  ...
  <script src="../js/hardgame.js"></script>
